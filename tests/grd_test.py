...
vals = sph_harm(5,6, lons, lats).real
...
fig = pygmt.GMT_Figure("output.ps", range='g', projection='G-75/41/7i', verbose=False)
grid = fig.surface('-I5/5 -Rg', pygmt.GMT_Vector([lons,lats,vals]))
